<html>
 <head>
       <title>Club natació Tortosa - Documents</title>
        <meta charset="UTF-8">
    ...
    <body>
	    ...
	    <div class="container">
				<div class="row">
					<div class="col-md12">
						<h1 class="text-center title-page">Documents</h1>
					</div>
				</div>
		</div>
    	<div class="container">
		    ...
		    <?php foreach($this->_ci_cached_vars as $index => $llistardocument){ ?>	
			   	<div class="panel-body">
					<p>
				    	<span class="glyphicon glyphicon-file">&nbsp;</span><a class="btn  btn-read-more" target="_blank" href="<?php echo $llistardocument['document']; ?>"> <?php $nom = basename($llistardocument['titul'], ".pdf"); echo $nom;?> </a>
				    </p>
				</div>					
		    <?php } ?>
		   </div>
