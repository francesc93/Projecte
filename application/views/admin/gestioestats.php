...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Gestió d'estats</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Introdueix un nou estat</div>
					<div class="panel-body">
						<div class="col-md-6">
					
						<?php echo validation_errors(); //validar dades ?> 
						<form action="insertar_estat" method="post" enctype="multipart/form-data">							
								<div class="form-group">
									<label>Estat</label>
									<input class="form-control" name="estat" value="<?php echo set_value('estat'); ?>" placeholder="Estat">
								</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="state">id Estats</th>
						        <th data-field="id">Estat</th>
						        <th data-field="name" >Accions</th>
						    </tr>
						    </thead>
						    <tbody>
						    	 <?php foreach($estats as $index => $llistarestat){ ?>
            					<tr>
                					<td><?php echo $llistarestat['ID_ESTAT']; ?></td>
					                <td><?php echo $llistarestat['ESTAT']; ?></td>
					                <td>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        ...
			        <h4 class="modal-id" id="exampleModalLabel">Modificar Estats</h4>			   		
			      </div>
